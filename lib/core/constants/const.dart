...
class TextConst {
  static String t = 'Hey there';

  static String t1 = 'Create an Account';
  static String t2 =
      'By continuing you accept our Privacy Policy and Term of Use';
  static String t3 = 'Already have an account?';
...
class PaddingMarginConst {
  ...
  static EdgeInsets kExtraLargePadding = const EdgeInsets.all(20);
}
